...
const Dashboard = () => {
  ...
  async function fetchedAssigmentTotal() {
    try {
      const response = await fetch("http://16.170.170.180:8080/api/assigment/allAssigment", {
        method: "GET", headers: {
  ...
  async function fetchedItemAssigment() {
    try {
      const response = await fetch("http://16.170.170.180:8080/api/itemA/allAssigment", {
        method: "GET", headers: {
          'Accept': 'application/json', "Content-Type": "application/json",
        }, redirect: "follow",
      });
  ...
  async function fetchedCartTotal() {
    try {
      const response = await fetch("http://16.170.170.180:8080/api/items/allItems", {
        method: "GET", headers: {
          'Accept': 'application/json', "Content-Type": "application/json",
        }, redirect: "follow",
      });
  ...
  async function fetchedItemCart() {
    try {
      const response = await fetch("http://16.170.170.180:8080/api/item/allCart", {
        method: "GET", headers: {
          'Accept': 'application/json', "Content-Type": "application/json",
        }, redirect: "follow",
      });
        ...
        <CCardBody>
          <CRow>
            <CCol sm={5}>
              ...
              <div
                className="small text-medium-emphasis">{Math.round((sumTotalAssigment + sumTotalCart) * 100) / 100} zł
              </div>
            </CCol>
        ...
        <CCardFooter>
          <CRow className="text-center">
            ...
            <CCol className="mb-sm-2 mb-0">
              ...
              <strong>
                {Math.round((allItems + allProjects) * 100) / 100} zł earn
                ({Math.ceil(((allItems + allProjects) / 50000 * 100) * 100) / 100}%)
              </strong>
